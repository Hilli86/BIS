...
from .technik import technik_bp
...
__all__ = ['auth_bp', 'schichtbuch_bp', 'admin_bp', 'ersatzteile_bp', 'dashboard_bp', 'import_bp', 'errors_bp', 'diverses_bp', 'search_bp', 'produktion_bp', 'wartungen_bp', 'print_agent_bp', 'technik_bp']
